                ...
                <div class="box-title">
                    <form class="form-inline">
                        ...
                        <select name="status" class="form-control">
                            ...
                            <option value="3" {{ Request::get('status') == 3 ? "selected='selected'" : "" }}>Giao hàng thành công</option>
                        ...
                        <button type="submit" name="createPDF" value="true" class="btn btn-info">
                            <i class="fa fa-save"></i> Bill
                        </button>
                    </form>
                </div>
                <div class="box-body">
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        ...
                                                        <li>
                                                            <a href="{{ route('admin.action.transaction',['success', $transaction->id]) }}" ><i class="fa fa-ban"></i> Giao hàng thành công</a>
                                                        </li>
                                                        <li>
